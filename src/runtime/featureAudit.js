...
const TARGET_FEATURES = [
  {
    ...
    expectedDashboardRefs: ["indicatorRegistry", "topPositiveFeatures", "missingIndicatorFeatures"],
    ...
    filesToChange: ["src/runtime/tradingBot.js", "src/dashboard/public/app.js"],
  ...
  },
  {
    ...
    expectedDashboardRefs: ["dynamicExitLevels", "suggestedStopPct", "suggestedTakeProfitPct"],
  ...
  },
  {
    ...
    expectedDashboardRefs: ["exitIntelligenceV2", "exitQuality", "currentExitRecommendation"],
    tests: ["test/exitIntelligenceV2.tests.js"],
    dashboardExpected: true,
    liveRisk: true,
    activationStage: "diagnostics_only",
    paperModeIntegration: "not_required",
    priority: "P3",
  ...
  },
  {
    ...
    expectedDashboardRefs: ["maximumFavorableExcursionPct", "maximumAdverseExcursionPct", "exitEfficiencyPct", "tradeQualitySummary"],
  ...
  },
  {
    ...
    expectedDashboardRefs: ["sectorRotation", "sectorRotationScore"],
    tests: ["test/decisionSupportFoundation.tests.js"],
    dashboardExpected: true,
    expectedUnusedUntilIntegrated: true,
    activationStage: "diagnostics_only",
  ...
  },
  {
    ...
    dashboardExpected: false,
    activationStage: "diagnostics_only",
    paperModeIntegration: "offline_only",
    priority: "complete",
...
export async function buildFeatureAudit({ config = {}, projectRoot = process.cwd() } = {}) {
  ...
  for (const definition of TARGET_FEATURES) {
    ...
    const feature = {
      ...
      activationStage: definition.activationStage || "diagnostics_only",
      paperModeIntegration: definition.paperModeIntegration || "not_required",
