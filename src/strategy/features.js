...
export function buildFeatureVector({
  ...
  return {
    ...
    ema_ribbon_compression: clamp((marketFeatures.emaRibbonCompressionScore || 0) * 3, 0, 3),
    ema_ribbon_expansion: clamp((marketFeatures.emaRibbonExpansionScore || 0) * 3, -3, 3),
    ema_ribbon_bias: clamp(((marketFeatures.emaRibbonBullishScore || 0) - (marketFeatures.emaRibbonBearishScore || 0)) * 3, -3, 3),
    vwap_band_position: clamp((marketFeatures.vwapBandPosition || 0) * 3, -3, 3),
    vwap_band_width: clamp((marketFeatures.vwapBandWidthPct || 0) * 80, 0, 4),
    rsi_divergence: clamp(((marketFeatures.rsiBullishDivergenceScore || 0) - (marketFeatures.rsiBearishDivergenceScore || 0)) * 3, -3, 3),
    macd_histogram_divergence: clamp(((marketFeatures.macdBullishDivergenceScore || 0) - (marketFeatures.macdBearishDivergenceScore || 0)) * 3, -3, 3),
    relative_volume_utc_hour: clamp(((marketFeatures.relativeVolumeByUtcHour || 1) - 1) * 2, -3, 3),
    relative_volume_utc_hour_z: clamp(marketFeatures.relativeVolumeByUtcHourZ || 0, -4, 4),
    volatility_of_volatility: clamp((marketFeatures.volatilityOfVolatilityScore || 0) * 3, 0, 3),
