...
const DEFAULT_HASH_KEYS = [
  ...
  "postReconcileMaxOpenPositions",
  "postReconcilePaperMaxOpenPositions",
  "postReconcileMaxNewEntriesPerCycle",
  "postReconcileMaxTotalExposureMultiplier",
  "postReconcileLiveSizeMultiplier",
  "postReconcilePaperSizeMultiplier",
  "minTradeUsdt",
  "paperMinTradeUsdt",
